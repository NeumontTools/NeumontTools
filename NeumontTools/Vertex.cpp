...
uint Neumont::Vertex::TANGENT_OFFSET = sizeof(vec3) + sizeof(vec4) + sizeof(vec3) + sizeof(vec2) + sizeof(uint) + sizeof(vec3);
uint Neumont::Vertex::BITANGENT_OFFSET = sizeof(vec3) + sizeof(vec4) + sizeof(vec3) + sizeof(vec2) + sizeof(uint) + sizeof(vec3) + sizeof(vec3);
